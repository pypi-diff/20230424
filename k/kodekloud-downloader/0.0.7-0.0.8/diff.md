# Comparing `tmp/kodekloud-downloader-0.0.7.tar.gz` & `tmp/kodekloud-downloader-0.0.8.tar.gz`
...
+gzip compressed data, was "kodekloud-downloader-0.0.8.tar", max compression
```

## Comparing `kodekloud-downloader-0.0.7.tar` & `kodekloud-downloader-0.0.8.tar`
...
+-rw-r--r--   0        0        0    14478 2023-04-24 14:55:09.957694 kodekloud-downloader-0.0.8/README.md
+-rw-r--r--   0        0        0     1102 2023-04-24 14:55:18.617463 kodekloud-downloader-0.0.8/pyproject.toml
+-rw-r--r--   0        0        0       22 2023-04-24 14:55:09.957694 kodekloud-downloader-0.0.8/src/kodekloud_downloader/__init__.py
+-rw-r--r--   0        0        0     1843 2023-04-24 14:55:09.957694 kodekloud-downloader-0.0.8/src/kodekloud_downloader/cli.py
+-rw-r--r--   0        0        0      134 2023-04-24 14:55:09.957694 kodekloud-downloader-0.0.8/src/kodekloud_downloader/enums.py
+-rw-r--r--   0        0        0     2239 2023-04-24 14:55:09.957694 kodekloud-downloader-0.0.8/src/kodekloud_downloader/helpers.py
+-rw-r--r--   0        0        0     3022 2023-04-24 14:55:09.957694 kodekloud-downloader-0.0.8/src/kodekloud_downloader/main.py
+-rw-r--r--   0        0        0     2010 2023-04-24 14:55:09.957694 kodekloud-downloader-0.0.8/src/kodekloud_downloader/models.py
+-rw-r--r--   0        0        0     1604 2023-04-24 14:55:09.957694 kodekloud-downloader-0.0.8/src/kodekloud_downloader/yt_dlp_patch.py
+-rw-r--r--   0        0        0    15769 2023-04-24 14:55:19.987109 kodekloud-downloader-0.0.8/setup.py
+-rw-r--r--   0        0        0    15366 2023-04-24 14:55:19.988723 kodekloud-downloader-0.0.8/PKG-INFO
```

### Comparing `kodekloud-downloader-0.0.7/README.md` & `kodekloud-downloader-0.0.8/README.md`

 * *Files identical despite different names*

### Comparing `kodekloud-downloader-0.0.7/pyproject.toml` & `kodekloud-downloader-0.0.8/pyproject.toml`
...
### Comparing `kodekloud-downloader-0.0.7/src/kodekloud_downloader/cli.py` & `kodekloud-downloader-0.0.8/src/kodekloud_downloader/cli.py`

 * *Files identical despite different names*

### Comparing `kodekloud-downloader-0.0.7/src/kodekloud_downloader/helpers.py` & `kodekloud-downloader-0.0.8/src/kodekloud_downloader/helpers.py`
...
### Comparing `kodekloud-downloader-0.0.7/src/kodekloud_downloader/main.py` & `kodekloud-downloader-0.0.8/src/kodekloud_downloader/main.py`

 * *Files identical despite different names*

### Comparing `kodekloud-downloader-0.0.7/src/kodekloud_downloader/models.py` & `kodekloud-downloader-0.0.8/src/kodekloud_downloader/models.py`

 * *Files identical despite different names*

### Comparing `kodekloud-downloader-0.0.7/src/kodekloud_downloader/yt_dlp_patch.py` & `kodekloud-downloader-0.0.8/src/kodekloud_downloader/yt_dlp_patch.py`

 * *Files identical despite different names*

### Comparing `kodekloud-downloader-0.0.7/setup.py` & `kodekloud-downloader-0.0.8/setup.py`
...
### Comparing `kodekloud-downloader-0.0.7/PKG-INFO` & `kodekloud-downloader-0.0.8/PKG-INFO`
