# Comparing `tmp/psychonaut-0.0.7.tar.gz` & `tmp/psychonaut-0.0.8.tar.gz`
...
## Comparing `psychonaut-0.0.7.tar` & `psychonaut-0.0.8.tar`
...
### Comparing `psychonaut-0.0.7/LICENSE` & `psychonaut-0.0.8/LICENSE`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/README.md` & `psychonaut-0.0.8/README.md`
...
### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/app/bsky/actor/get_profiles.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/app/bsky/actor/get_profiles.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/app/bsky/actor/get_suggestions.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/app/bsky/actor/get_suggestions.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/app/bsky/actor/profile.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/app/bsky/actor/profile.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/app/bsky/actor/search_actors.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/app/bsky/actor/search_actors.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/app/bsky/actor/search_actors_typeahead.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/app/bsky/actor/search_actors_typeahead.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/app/bsky/feed/get_author_feed.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/app/bsky/feed/get_author_feed.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/app/bsky/feed/get_likes.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/app/bsky/feed/get_likes.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/app/bsky/feed/get_post_thread.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/app/bsky/feed/get_post_thread.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/app/bsky/feed/get_reposted_by.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/app/bsky/feed/get_reposted_by.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/app/bsky/feed/get_timeline.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/app/bsky/feed/get_timeline.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/app/bsky/feed/post.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/app/bsky/feed/post.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/app/bsky/graph/follow.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/app/bsky/graph/follow.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/app/bsky/graph/get_followers.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/app/bsky/graph/get_followers.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/app/bsky/graph/get_follows.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/app/bsky/graph/get_follows.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/app/bsky/graph/get_mutes.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/app/bsky/graph/get_mutes.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/app/bsky/notification/get_unread_count.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/app/bsky/notification/get_unread_count.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/app/bsky/notification/list_notifications.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/app/bsky/notification/list_notifications.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/app/bsky/unspecced/get_popular.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/app/bsky/unspecced/get_popular.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/com/atproto/admin/get_invite_codes.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/com/atproto/admin/get_invite_codes.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/com/atproto/admin/get_moderation_actions.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/com/atproto/admin/get_moderation_actions.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/com/atproto/admin/get_moderation_reports.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/com/atproto/admin/get_moderation_reports.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/com/atproto/admin/get_record.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/com/atproto/admin/get_record.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/com/atproto/admin/search_repos.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/com/atproto/admin/search_repos.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/com/atproto/identity/resolve_handle.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/com/atproto/identity/resolve_handle.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/com/atproto/label/query_labels.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/com/atproto/label/query_labels.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/com/atproto/repo/describe_repo.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/com/atproto/repo/describe_repo.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/com/atproto/repo/get_record.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/com/atproto/repo/get_record.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/com/atproto/repo/list_records.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/com/atproto/repo/list_records.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/com/atproto/server/describe_server.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/com/atproto/server/describe_server.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/com/atproto/server/get_account_invite_codes.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/com/atproto/server/get_account_invite_codes.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/com/atproto/server/get_session.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/com/atproto/server/get_session.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/com/atproto/server/list_app_passwords.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/com/atproto/server/list_app_passwords.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/com/atproto/sync/get_blob.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/com/atproto/sync/get_blob.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/com/atproto/sync/get_blocks.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/com/atproto/sync/get_blocks.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/com/atproto/sync/get_checkout.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/com/atproto/sync/get_checkout.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/com/atproto/sync/get_commit_path.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/com/atproto/sync/get_commit_path.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/com/atproto/sync/get_head.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/com/atproto/sync/get_head.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/com/atproto/sync/get_record.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/com/atproto/sync/get_record.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/com/atproto/sync/get_repo.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/com/atproto/sync/get_repo.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/com/atproto/sync/list_blobs.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/com/atproto/sync/list_blobs.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/com/atproto/sync/list_repos.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/com/atproto/sync/list_repos.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/com/atproto/sync/notify_of_update.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/com/atproto/sync/notify_of_update.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/lexicons/com/atproto/sync/request_crawl.py` & `psychonaut-0.0.8/psychonaut/api/lexicons/com/atproto/sync/request_crawl.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/api/session.py` & `psychonaut-0.0.8/psychonaut/api/session.py`
...
+        # I think this is true (for query methods?): TODO
...
### Comparing `psychonaut-0.0.7/psychonaut/cli/config.py` & `psychonaut-0.0.8/psychonaut/cli/config.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/cli/graph.py` & `psychonaut-0.0.8/psychonaut/cli/graph.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/cli/poasting.py` & `psychonaut-0.0.8/psychonaut/cli/poasting.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/cli/useful_queries.py` & `psychonaut-0.0.8/psychonaut/cli/useful_queries.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/client/__init__.py` & `psychonaut-0.0.8/psychonaut/client/__init__.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/common_web/ipld.py` & `psychonaut-0.0.8/psychonaut/common_web/ipld.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/identifier/did.py` & `psychonaut-0.0.8/psychonaut/identifier/did.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/identifier/did_test.py` & `psychonaut-0.0.8/psychonaut/identifier/did_test.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/identifier/handle.py` & `psychonaut-0.0.8/psychonaut/identifier/handle.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/identifier/handle_test.py` & `psychonaut-0.0.8/psychonaut/identifier/handle_test.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/identifier/reserved.py` & `psychonaut-0.0.8/psychonaut/identifier/reserved.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/identifier/resolve.py` & `psychonaut-0.0.8/psychonaut/identifier/resolve.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/lexicon/blob_refs.py` & `psychonaut-0.0.8/psychonaut/lexicon/blob_refs.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/lexicon/codegen.py` & `psychonaut-0.0.8/psychonaut/lexicon/codegen.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/lexicon/defs.py` & `psychonaut-0.0.8/psychonaut/lexicon/defs.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/lexicon/fields.py` & `psychonaut-0.0.8/psychonaut/lexicon/fields.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/lexicon/fields_test.py` & `psychonaut-0.0.8/psychonaut/lexicon/fields_test.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/lexicon/formats.py` & `psychonaut-0.0.8/psychonaut/lexicon/formats.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/lexicon/formats_test.py` & `psychonaut-0.0.8/psychonaut/lexicon/formats_test.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/lexicon/tools.py` & `psychonaut-0.0.8/psychonaut/lexicon/tools.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/lexicon/types.py` & `psychonaut-0.0.8/psychonaut/lexicon/types.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/lexicon/types_test.py` & `psychonaut-0.0.8/psychonaut/lexicon/types_test.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/lexicon/util.py` & `psychonaut-0.0.8/psychonaut/lexicon/util.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/nsid/nsid.py` & `psychonaut-0.0.8/psychonaut/nsid/nsid.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/nsid/nsid_test.py` & `psychonaut-0.0.8/psychonaut/nsid/nsid_test.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/uri/__init__.py` & `psychonaut-0.0.8/psychonaut/uri/__init__.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/uri/uri_test.py` & `psychonaut-0.0.8/psychonaut/uri/uri_test.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/psychonaut/uri/validation.py` & `psychonaut-0.0.8/psychonaut/uri/validation.py`

 * *Files identical despite different names*

### Comparing `psychonaut-0.0.7/pyproject.toml` & `psychonaut-0.0.8/pyproject.toml`
...
### Comparing `psychonaut-0.0.7/PKG-INFO` & `psychonaut-0.0.8/PKG-INFO`
