# Comparing `tmp/PyVkBot-1.0.5.tar.gz` & `tmp/pyvkbot-2.0.0.tar.gz`
...
## Comparing `PyVkBot-1.0.5.tar` & `pyvkbot-2.0.0.tar`
...
### Comparing `PyVkBot-1.0.5/PKG-INFO` & `pyvkbot-2.0.0/PKG-INFO`
...
### Comparing `PyVkBot-1.0.5/PyVkBot/Bot.py` & `pyvkbot-2.0.0/pyvkbot/Bot.py`
...
### Comparing `PyVkBot-1.0.5/PyVkBot/Types.py` & `pyvkbot-2.0.0/pyvkbot/Types.py`

 * *Files identical despite different names*

### Comparing `PyVkBot-1.0.5/PyVkBot.egg-info/PKG-INFO` & `pyvkbot-2.0.0/README.md`
