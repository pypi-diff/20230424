# Comparing `tmp/gama_config-1.13.0.tar.gz` & `tmp/gama_config-1.9.0.tar.gz`
...
### Comparing `gama_config-1.13.0/gama_config/generate_schemas.py` & `gama_config-1.9.0/gama_config/generate_schemas.py`
