# Comparing `tmp/griptape-0.5.1.tar.gz` & `tmp/griptape-0.6.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "griptape-0.5.1.tar", max compression
+gzip compressed data, was "griptape-0.6.0.tar", max compression
```

## Comparing `griptape-0.5.1.tar` & `griptape-0.6.0.tar`

### file list

```diff
@@ -1,5 +1,110 @@
--rw-r--r--   0        0        0    11339 2023-04-06 20:17:23.178260 griptape-0.5.1/LICENSE
--rw-r--r--   0        0        0     5321 2023-04-21 20:59:51.767657 griptape-0.5.1/README.md
--rw-r--r--   0        0        0       65 2023-04-18 23:10:38.312719 griptape-0.5.1/griptape/__init__.py
--rw-r--r--   0        0        0      529 2023-04-21 21:00:42.626177 griptape-0.5.1/pyproject.toml
--rw-r--r--   0        0        0     6074 1970-01-01 00:00:00.000000 griptape-0.5.1/PKG-INFO
...
### Comparing `griptape-0.5.1/LICENSE` & `griptape-0.6.0/LICENSE`
