# Comparing `tmp/aacommpy-0.1.7.tar.gz` & `tmp/aacommpy-0.1.8.tar.gz`
...
## Comparing `aacommpy-0.1.7.tar` & `aacommpy-0.1.8.tar`
...
### Comparing `aacommpy-0.1.7/PKG-INFO` & `aacommpy-0.1.8/PKG-INFO`
...
### Comparing `aacommpy-0.1.7/aacommpy/curves.py` & `aacommpy-0.1.8/aacommpy/curves.py`

 * *Files identical despite different names*

### Comparing `aacommpy-0.1.7/aacommpy/entry_points.py` & `aacommpy-0.1.8/aacommpy/entry_points.py`
...
### Comparing `aacommpy-0.1.7/aacommpy.egg-info/PKG-INFO` & `aacommpy-0.1.8/aacommpy.egg-info/PKG-INFO`
...
### Comparing `aacommpy-0.1.7/setup.py` & `aacommpy-0.1.8/setup.py`
