# Comparing `tmp/aacommpy-0.1.3.tar.gz` & `tmp/aacommpy-0.1.4.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "aacommpy-0.1.3.tar", last modified: Mon Apr 24 12:50:42 2023, max compression
+gzip compressed data, was "aacommpy-0.1.4.tar", last modified: Mon Apr 24 13:07:19 2023, max compression
```

## Comparing `aacommpy-0.1.3.tar` & `aacommpy-0.1.4.tar`

### file list

```diff
@@ -1,18 +1,18 @@
-drwxrwxrwx   0        0        0        0 2023-04-24 12:50:42.776646 aacommpy-0.1.3/
--rw-rw-rw-   0        0        0      533 2023-04-24 12:50:42.776646 aacommpy-0.1.3/PKG-INFO
--rw-rw-rw-   0        0        0       50 2023-04-24 12:46:06.000000 aacommpy-0.1.3/README.md
-drwxrwxrwx   0        0        0        0 2023-04-24 12:50:42.764164 aacommpy-0.1.3/aacommpy/
--rw-rw-rw-   0        0        0       95 2023-04-24 11:51:36.000000 aacommpy-0.1.3/aacommpy/__init__.py
--rw-rw-rw-   0        0        0      263 2023-04-24 12:50:37.000000 aacommpy-0.1.3/aacommpy/__version__.py
--rw-rw-rw-   0        0        0    10361 2023-04-23 17:15:24.000000 aacommpy-0.1.3/aacommpy/curves.py
--rw-rw-rw-   0        0        0     1157 2023-04-24 12:43:28.000000 aacommpy-0.1.3/aacommpy/entry_points.py
-drwxrwxrwx   0        0        0        0 2023-04-24 12:50:42.775649 aacommpy-0.1.3/aacommpy.egg-info/
--rw-rw-rw-   0        0        0      533 2023-04-24 12:50:42.000000 aacommpy-0.1.3/aacommpy.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      332 2023-04-24 12:50:42.000000 aacommpy-0.1.3/aacommpy.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2023-04-24 12:50:42.000000 aacommpy-0.1.3/aacommpy.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0       56 2023-04-24 12:50:42.000000 aacommpy-0.1.3/aacommpy.egg-info/entry_points.txt
--rw-rw-rw-   0        0        0        2 2023-04-24 12:09:32.000000 aacommpy-0.1.3/aacommpy.egg-info/not-zip-safe
--rw-rw-rw-   0        0        0       15 2023-04-24 12:50:42.000000 aacommpy-0.1.3/aacommpy.egg-info/requires.txt
--rw-rw-rw-   0        0        0        9 2023-04-24 12:50:42.000000 aacommpy-0.1.3/aacommpy.egg-info/top_level.txt
--rw-rw-rw-   0        0        0       42 2023-04-24 12:50:42.776646 aacommpy-0.1.3/setup.cfg
--rw-rw-rw-   0        0        0     1359 2023-04-24 12:50:30.000000 aacommpy-0.1.3/setup.py
...
### Comparing `aacommpy-0.1.3/PKG-INFO` & `aacommpy-0.1.4/PKG-INFO`
...
### Comparing `aacommpy-0.1.3/aacommpy/curves.py` & `aacommpy-0.1.4/aacommpy/curves.py`

 * *Files identical despite different names*

### Comparing `aacommpy-0.1.3/aacommpy/entry_points.py` & `aacommpy-0.1.4/aacommpy/entry_points.py`
...
### Comparing `aacommpy-0.1.3/aacommpy.egg-info/PKG-INFO` & `aacommpy-0.1.4/aacommpy.egg-info/PKG-INFO`
...
### Comparing `aacommpy-0.1.3/setup.py` & `aacommpy-0.1.4/setup.py`
