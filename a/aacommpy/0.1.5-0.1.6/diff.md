# Comparing `tmp/aacommpy-0.1.5.tar.gz` & `tmp/aacommpy-0.1.6.tar.gz`
...
## Comparing `aacommpy-0.1.5.tar` & `aacommpy-0.1.6.tar`
...
### Comparing `aacommpy-0.1.5/PKG-INFO` & `aacommpy-0.1.6/PKG-INFO`
...
### Comparing `aacommpy-0.1.5/aacommpy/curves.py` & `aacommpy-0.1.6/aacommpy/curves.py`

 * *Files identical despite different names*

### Comparing `aacommpy-0.1.5/aacommpy/entry_points.py` & `aacommpy-0.1.6/aacommpy/entry_points.py`
...
### Comparing `aacommpy-0.1.5/aacommpy.egg-info/PKG-INFO` & `aacommpy-0.1.6/aacommpy.egg-info/PKG-INFO`
...
### Comparing `aacommpy-0.1.5/setup.py` & `aacommpy-0.1.6/setup.py`
