# Comparing `tmp/anomalo-0.14.0.tar.gz` & `tmp/anomalo-0.9.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "anomalo-0.14.0.tar", last modified: Mon Apr 24 16:55:35 2023, max compression
+gzip compressed data, was "dist/anomalo-0.9.1.tar", last modified: Wed Sep  7 16:54:04 2022, max compression
```

## Comparing `anomalo-0.14.0.tar` & `anomalo-0.9.1.tar`

### file list

```diff
@@ -1,31 +1,22 @@
-drwxrwxrwx   0 root         (0) root         (0)        0 2023-04-24 16:55:35.377579 anomalo-0.14.0/
--rw-rw-rw-   0 root         (0) root         (0)       33 2023-04-12 11:00:46.000000 anomalo-0.14.0/.gitignore
--rw-rw-rw-   0 root         (0) root         (0)    11344 2023-04-12 11:00:46.000000 anomalo-0.14.0/LICENSE.txt
--rw-rw-rw-   0 root         (0) root         (0)      330 2023-04-24 16:55:35.377579 anomalo-0.14.0/PKG-INFO
--rw-rw-rw-   0 root         (0) root         (0)      211 2023-04-12 11:00:46.000000 anomalo-0.14.0/README.txt
-drwxrwxrwx   0 root         (0) root         (0)        0 2023-04-24 16:55:35.373579 anomalo-0.14.0/anomalo/
--rw-rw-rw-   0 root         (0) root         (0)       99 2023-04-24 16:54:05.000000 anomalo-0.14.0/anomalo/__init__.py
--rw-rw-rw-   0 root         (0) root         (0)       35 2023-04-12 11:00:46.000000 anomalo-0.14.0/anomalo/__main__.py
--rw-rw-rw-   0 root         (0) root         (0)       23 2023-04-24 16:55:32.000000 anomalo-0.14.0/anomalo/_version.py
--rwxrwxrwx   0 root         (0) root         (0)      250 2023-04-24 16:54:05.000000 anomalo-0.14.0/anomalo/anomalo.py
-drwxrwxrwx   0 root         (0) root         (0)        0 2023-04-24 16:55:35.377579 anomalo-0.14.0/anomalo/cli/
--rw-rw-rw-   0 root         (0) root         (0)        0 2023-04-24 16:54:05.000000 anomalo-0.14.0/anomalo/cli/__init__.py
--rw-rw-rw-   0 root         (0) root         (0)      699 2023-04-24 16:54:05.000000 anomalo-0.14.0/anomalo/cli/cli.py
--rw-rw-rw-   0 root         (0) root         (0)     7878 2023-04-24 16:54:05.000000 anomalo-0.14.0/anomalo/cli/models.py
--rw-rw-rw-   0 root         (0) root         (0)     6134 2023-04-24 16:54:05.000000 anomalo-0.14.0/anomalo/cli/state.py
--rw-rw-rw-   0 root         (0) root         (0)     9946 2023-04-24 16:54:05.000000 anomalo-0.14.0/anomalo/client.py
--rw-rw-rw-   0 root         (0) root         (0)     3425 2023-04-12 11:00:46.000000 anomalo-0.14.0/anomalo/encoder.py
-drwxrwxrwx   0 root         (0) root         (0)        0 2023-04-24 16:55:35.377579 anomalo-0.14.0/anomalo.egg-info/
--rw-rw-rw-   0 root         (0) root         (0)      330 2023-04-24 16:55:35.000000 anomalo-0.14.0/anomalo.egg-info/PKG-INFO
--rw-rw-rw-   0 root         (0) root         (0)      519 2023-04-24 16:55:35.000000 anomalo-0.14.0/anomalo.egg-info/SOURCES.txt
--rw-rw-rw-   0 root         (0) root         (0)        1 2023-04-24 16:55:35.000000 anomalo-0.14.0/anomalo.egg-info/dependency_links.txt
--rw-rw-rw-   0 root         (0) root         (0)       49 2023-04-24 16:55:35.000000 anomalo-0.14.0/anomalo.egg-info/entry_points.txt
--rw-rw-rw-   0 root         (0) root         (0)       34 2023-04-24 16:55:35.000000 anomalo-0.14.0/anomalo.egg-info/requires.txt
--rw-rw-rw-   0 root         (0) root         (0)        8 2023-04-24 16:55:35.000000 anomalo-0.14.0/anomalo.egg-info/top_level.txt
-drwxrwxrwx   0 root         (0) root         (0)        0 2023-04-24 16:55:35.377579 anomalo-0.14.0/examples/
--rw-rw-rw-   0 root         (0) root         (0)     3642 2023-04-12 11:00:46.000000 anomalo-0.14.0/examples/bulk_rerun.py
--rw-rw-rw-   0 root         (0) root         (0)     1284 2023-04-12 11:00:46.000000 anomalo-0.14.0/examples/sample.py
--rw-rw-rw-   0 root         (0) root         (0)     3575 2023-04-12 11:00:46.000000 anomalo-0.14.0/examples/table_save_load.py
--rw-rw-rw-   0 root         (0) root         (0)       29 2023-04-12 11:00:46.000000 anomalo-0.14.0/requirements.txt
--rw-rw-rw-   0 root         (0) root         (0)       38 2023-04-24 16:55:35.377579 anomalo-0.14.0/setup.cfg
--rw-rw-rw-   0 root         (0) root         (0)      953 2023-04-12 11:00:46.000000 anomalo-0.14.0/setup.py
...
### Comparing `anomalo-0.14.0/LICENSE.txt` & `anomalo-0.9.1/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `anomalo-0.14.0/anomalo/client.py` & `anomalo-0.9.1/anomalo/anomalo.py`
...
### Comparing `anomalo-0.14.0/examples/bulk_rerun.py` & `anomalo-0.9.1/examples/bulk_rerun.py`
...
### Comparing `anomalo-0.14.0/examples/sample.py` & `anomalo-0.9.1/examples/sample.py`

 * *Files identical despite different names*

### Comparing `anomalo-0.14.0/setup.py` & `anomalo-0.9.1/setup.py`
