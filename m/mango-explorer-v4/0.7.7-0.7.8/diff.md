# Comparing `tmp/mango_explorer_v4-0.7.7.tar.gz` & `tmp/mango_explorer_v4-0.7.8.tar.gz`
...
### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/examples/place_order.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/examples/place_order.py`
...
### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/instructions/serum3_cancel_all_orders.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/instructions/serum3_cancel_all_orders.py`
...
### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/instructions/serum3_register_market.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/instructions/serum3_register_market.py`
...
### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/oracles/pyth/__init__.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/oracles/pyth/__init__.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/__init__.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/__init__.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/any_event.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/any_event.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/any_node.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/any_node.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/book_side_order_tree.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/book_side_order_tree.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/equity.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/equity.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/event_queue_header.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/event_queue_header.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/event_type.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/event_type.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/fill_event.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/fill_event.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/flash_loan_token_detail.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/flash_loan_token_detail.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/flash_loan_type.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/flash_loan_type.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/health_cache.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/health_cache.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/health_type.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/health_type.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/i80f48.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/i80f48.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/inner_node.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/inner_node.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/interest_rate_params.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/interest_rate_params.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/ix_gate.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/ix_gate.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/leaf_node.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/leaf_node.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/loan_origination_fee_instruction.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/loan_origination_fee_instruction.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/mango_account_fixed.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/mango_account_fixed.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/node_tag.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/node_tag.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/oracle_config.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/oracle_config.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/oracle_config_params.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/oracle_config_params.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/oracle_type.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/oracle_type.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/order_params.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/order_params.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/order_state.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/order_state.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/order_tree_nodes.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/order_tree_nodes.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/order_tree_root.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/order_tree_root.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/order_tree_type.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/order_tree_type.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/out_event.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/out_event.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/perp_equity.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/perp_equity.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/perp_info.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/perp_info.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/perp_market_index.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/perp_market_index.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/perp_open_order.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/perp_open_order.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/perp_position.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/perp_position.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/place_order_type.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/place_order_type.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/post_order_type.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/post_order_type.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/prices.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/prices.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/serum3_info.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/serum3_info.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/serum3_market_index.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/serum3_market_index.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/serum3_order_type.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/serum3_order_type.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/serum3_orders.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/serum3_orders.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/serum3_self_trade_behavior.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/serum3_self_trade_behavior.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/serum3_side.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/serum3_side.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/side.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/side.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/side_and_order_tree.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/side_and_order_tree.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/stable_price_model.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/stable_price_model.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/token_equity.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/token_equity.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/token_index.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/token_index.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/token_info.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/token_info.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/mango_explorer_v4/types/token_position.py` & `mango_explorer_v4-0.7.8/mango_explorer_v4/types/token_position.py`

 * *Files identical despite different names*

### Comparing `mango_explorer_v4-0.7.7/pyproject.toml` & `mango_explorer_v4-0.7.8/pyproject.toml`
...
### Comparing `mango_explorer_v4-0.7.7/PKG-INFO` & `mango_explorer_v4-0.7.8/PKG-INFO`
