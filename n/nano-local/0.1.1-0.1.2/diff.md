# Comparing `tmp/nano_local-0.1.1.tar.gz` & `tmp/nano_local-0.1.2.tar.gz`
...
## Comparing `nano_local-0.1.1.tar` & `nano_local-0.1.2.tar`
...
### Comparing `nano_local-0.1.1/README.md` & `nano_local-0.1.2/README.md`

 * *Files identical despite different names*

### Comparing `nano_local-0.1.1/nanolocal/nl_module.py` & `nano_local-0.1.2/nanolocal/nl_module.py`

 * *Files identical despite different names*

### Comparing `nano_local-0.1.1/nanolocal/testcases/basic.py` & `nano_local-0.1.2/nanolocal/testcases/basic.py`
