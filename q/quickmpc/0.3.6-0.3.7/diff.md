# Comparing `tmp/quickmpc-0.3.6.tar.gz` & `tmp/quickmpc-0.3.7.tar.gz`
...
### Comparing `quickmpc-0.3.6/tests/unit_tests/test_make_pieces.py` & `quickmpc-0.3.7/tests/unit_tests/test_make_pieces.py`
