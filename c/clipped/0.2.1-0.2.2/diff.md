# Comparing `tmp/clipped-0.2.1.tar.gz` & `tmp/clipped-0.2.2.tar.gz`
...
### Comparing `clipped-0.2.1/clipped/types/docker_image.py` & `clipped-0.2.2/clipped/types/docker_image.py`
