# Comparing `tmp/robotframework_difflibext-0.0.2-py3-none-any.whl.zip` & `tmp/robotframework_difflibext-0.0.3-py3-none-any.whl.zip`
...
## Comparing `robotframework_difflibext-0.0.2.dist-info/LICENSE` & `robotframework_difflibext-0.0.3.dist-info/LICENSE`
