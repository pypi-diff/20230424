# Comparing `tmp/NeuralBasics-1.0.7.tar.gz` & `tmp/NeuralBasics-1.0.8.tar.gz`
...
## Comparing `NeuralBasics-1.0.7.tar` & `NeuralBasics-1.0.8.tar`
...
### Comparing `NeuralBasics-1.0.7/PKG-INFO` & `NeuralBasics-1.0.8/NeuralBasics.egg-info/PKG-INFO`
...
### Comparing `NeuralBasics-1.0.7/pyproject.toml` & `NeuralBasics-1.0.8/pyproject.toml`
...
### Comparing `NeuralBasics-1.0.7/src/NeuralBasics.egg-info/PKG-INFO` & `NeuralBasics-1.0.8/PKG-INFO`
