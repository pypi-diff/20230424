# Comparing `tmp/NeuralBasics-1.0.2.tar.gz` & `tmp/NeuralBasics-1.0.3.tar.gz`
...
## Comparing `NeuralBasics-1.0.2.tar` & `NeuralBasics-1.0.3.tar`
...
### Comparing `NeuralBasics-1.0.2/NeuralBasics.egg-info/PKG-INFO` & `NeuralBasics-1.0.3/NeuralBasics.egg-info/PKG-INFO`
...
### Comparing `NeuralBasics-1.0.2/PKG-INFO` & `NeuralBasics-1.0.3/PKG-INFO`
...
### Comparing `NeuralBasics-1.0.2/pyproject.toml` & `NeuralBasics-1.0.3/pyproject.toml`
