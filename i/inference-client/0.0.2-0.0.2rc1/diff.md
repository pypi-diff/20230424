# Comparing `tmp/inference_client-0.0.2.tar.gz` & `tmp/inference_client-0.0.2rc1.tar.gz`
...
### Comparing `inference_client-0.0.2/LICENSE` & `inference_client-0.0.2rc1/LICENSE`
